...
#if BRUSH_SOL_INT == 2
    print*,"  *  Brush Monomers - Solvent interaction is via Soft-Potential"
    print*,"  - Strength of interaction is a = epsil(2,3)"
#elif BRUSH_SOL_INT == 1    
    print*,"  *  Brush Monomers - Solvent interaction is via Lennard-Jones Pot"
#endif
